...
class WeatherApp(QMainWindow, Ui_MainWindow):
    ...
    def initUI(self):
        ...
        self.setWindowTitle('new Weather')
...
def set_up_taskbar_image():
    # This function lets you display the app icon in the taskbar (Linux version)
    if platform.system() == 'Linux':
        #app_id = "your_app_id_here"  # Set your desired App ID for Linux
        #ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(app_id)
        pass
    # elif platform.system() == 'Windows':
    #    app_id = u'mycompany.myproduct.subproduct.version'  # Arbitrary string for Windows
    #    ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(app_id)
